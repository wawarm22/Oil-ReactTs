                            ...
                            <div className="position-relative" style={{ width: '300px' }}>
                                ...
                                <form>
                                    <div className="mb-3 input-group">
                                        ...
                                        <input type="email" className="form-control bg-white border-0 rounded-end-3" placeholder="อีเมล" />
                                    </div>
                                    ...
                                    <div className="mb-3 input-group">
                                        ...
                                        <input type="password" className="form-control bg-white border-0 rounded-end-3" placeholder="รหัสผ่าน" />
                                    </div>

                                    <div className="d-flex justify-content-between align-items-center" style={{ fontSize: '16px' }}>
                                        ...
                                        <a href="#" className="text-white text-decoration-none">ลืมรหัสผ่าน?</a>
                                    </div>

                                    <div className="d-flex gap-2 mt-5">
                                        <button type="button" className="btn flex-fill rounded-pill text-white fw-bold" style={{ backgroundColor: '#404A57', fontSize: '18px' }}>ลงทะเบียน</button>
                                        <button type="submit" className="btn flex-fill rounded-pill fw-bold" style={{ backgroundColor: '#FFCB02', fontSize: '18px' }}>เข้าสู่ระบบ</button>
                                    </div>
                                </form>
                            </div>
                        </div>
