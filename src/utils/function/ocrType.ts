...
export const detectOcrType = (fields: Record<string, any>): OcrFields["type"] => {
    ...
    if ("docType" in fields && typeof fields.docType === "string") {
        ...
        if (docType === "oil-tax-request-st-page-1" || docType === "oil-tax-request-st-page-2") {
            return "tax"
        }
        ...
        if (docType === "oil-outturn-report-1") {
            return "outturn_report";
        }

        if (docType === "oil-formular-1" || docType === "oil-formular-2" || docType === "oil-formular-3") {
